...
//					retModel->meshes[i].frames[j].tangents = (float*)malloc(sizeof(float));//(float*)Z_Malloc(sizeof(float)*3*mdS->numTriangles*3, ztag);
				...
				{
					float x1 = mdV[mdT->index[0]].x * dataScale;
					float y1 = mdV[mdT->index[0]].z * dataScale;
					float z1 = mdV[mdT->index[0]].y * dataScale;

					float x2 = mdV[mdT->index[1]].x * dataScale;
					float y2 = mdV[mdT->index[1]].z * dataScale;
					float z2 = mdV[mdT->index[1]].y * dataScale;

					float x3 = mdV[mdT->index[2]].x * dataScale;
					float y3 = mdV[mdT->index[2]].z * dataScale;
					float z3 = mdV[mdT->index[2]].y * dataScale;
